...
import { FiHome, FiUser, FiSettings, FiBox } from 'react-icons/fi';
...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-10 relative transition-all p-2 md:p-4">
            ...
            <>
              ...
              <NavLink
                ...
                className={({ isActive, isPending }) => {
                  ...
                  const activeClasses = 'bg-blue-500 dark:bg-blue-600';
